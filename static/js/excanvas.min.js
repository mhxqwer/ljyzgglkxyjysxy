...
<body>
    ...
    <div class="message">
            ...
            <div class="info">
                <div>
                    <h2>[0]&nbsp;<abbr title="think\exception\HttpException">HttpException</abbr> in <a class="toggle" title="D:\www\jwork_php_zgymba\thinkphp\library\think\App.php line 577">App.php line 577</a></h2>
                </div>
                <div><h1>controller not exists:app\index\controller\AssetsController</h1></div>
            </div>
        
    </div>
	        <div class="source-code">
            <pre class="prettyprint lang-php"><ol start="568"><li class="line-568"><code>
</code></li><li class="line-569"><code>        try {
</code></li><li class="line-570"><code>            $instance = Loader::controller(
</code></li><li class="line-571"><code>                $controller,
</code></li><li class="line-572"><code>                $config['url_controller_layer'],
</code></li><li class="line-573"><code>                $config['controller_suffix'],
</code></li><li class="line-574"><code>                $config['empty_controller']
</code></li><li class="line-575"><code>            );
</code></li><li class="line-576"><code>        } catch (ClassNotFoundException $e) {
</code></li><li class="line-577"><code>            throw new HttpException(404, 'controller not exists:' . $e-&gt;getClass());
</code></li><li class="line-578"><code>        }
</code></li><li class="line-579"><code>
</code></li><li class="line-580"><code>        // 获取当前操作名
</code></li><li class="line-581"><code>        $action = $actionName . $config['action_suffix'];
</code></li><li class="line-582"><code>
</code></li><li class="line-583"><code>        $vars = [];
</code></li><li class="line-584"><code>        if (is_callable([$instance, $action])) {
</code></li><li class="line-585"><code>            // 执行操作方法
</code></li><li class="line-586"><code>            $call = [$instance, $action];
</code></li></ol></pre>
        </div>
	        <div class="trace">
            <h2>Call Stack</h2>
            <ol>
                <li>in <a class="toggle" title="D:\www\jwork_php_zgymba\thinkphp\library\think\App.php line 577">App.php line 577</a></li>
                                <li>
                at <abbr title="think\App">App</abbr>::module(['index', 'assets', 'global'], ['app_host' => '', 'app_debug' => <em>true</em>, 'app_trace' => <em>false</em>, ...], <em>null</em>) in <a class="toggle" title="D:\www\jwork_php_zgymba\thinkphp\library\think\App.php line 457">App.php line 457</a>                </li>
                                <li>
                at <abbr title="think\App">App</abbr>::exec(['type' => 'module', 'module' => ['index', 'assets', 'global']], ['app_host' => '', 'app_debug' => <em>true</em>, 'app_trace' => <em>false</em>, ...]) in <a class="toggle" title="D:\www\jwork_php_zgymba\thinkphp\library\think\App.php line 139">App.php line 139</a>                </li>
                                <li>
                at <abbr title="think\App">App</abbr>::run() in <a class="toggle" title="D:\www\jwork_php_zgymba\thinkphp\start.php line 19">start.php line 19</a>                </li>
                                <li>
                at require('<a class="toggle" title="D:\www\jwork_php_zgymba\thinkphp\start.php">D:\www\jwork_php_zgy...</a>') in <a class="toggle" title="D:\www\jwork_php_zgymba\index.php line 18">index.php line 18</a>                </li>
                            </ol>
        </div>
    </div>
        ...
        <h2>Environment Variables</h2>
            ...
            <div>
                    ...
                    <div class="col-md-9"><small>
                        \\.\pipe\IISFCGI-2271b5e7-94b7-4b6c-91c2-b8e06c841343                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        D:\php\                    </small></div>
                                ...
                                <div class="clearfix">
                    <div class="col-md-3"><strong>PHP_FCGI_MAX_REQUESTS</strong></div>
                    <div class="col-md-9"><small>
                        10000                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        C:\inetpub\temp\apppools\www.zgymba.com\www.zgymba.com.config                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>APP_POOL_ID</strong></div>
                    <div class="col-md-9"><small>
                        www.zgymba.com                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        Intel64 Family 6 Model 85 Stepping 4, GenuineIntel                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        /index.php/index/assets/global/plugins/excanvas.min.js                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\index.php                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>REQUEST_URI</strong></div>
                    <div class="col-md-9"><small>
                        /index/assets/global/plugins/excanvas.min.js                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\index.php\index\assets\global\plugins\excanvas.min.js                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        http://www.zgymba.com/index/assets/global/plugins/excanvas.min.js                    </small></div>
                </div>
                                <div class="clearfix">
            ...
            <div>
                    ...
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba/application/                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>EXTEND_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba/extend/                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\thinkphp\                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>LIB_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\thinkphp\library\                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>CORE_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\thinkphp\library\think\                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>TRAIT_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\thinkphp\library\traits\                    </small></div>
                </div>
                                <div class="clearfix">
                    ...
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\vendor\                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>RUNTIME_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\runtime\                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>LOG_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\runtime\log\                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>CACHE_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\runtime\cache\                    </small></div>
                </div>
                                <div class="clearfix">
                    <div class="col-md-3"><strong>TEMP_PATH</strong></div>
                    <div class="col-md-9"><small>
                        D:\www\jwork_php_zgymba\runtime\temp\                    </small></div>
                </div>
                                <div class="clearfix">
